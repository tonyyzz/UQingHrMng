...
namespace Com.Admin.Alipay
{
    ...
    public class Core
    {
        ...
        public static Dictionary<string, string> FilterPara(SortedDictionary<string, string> dicArrayPre)
        {
            ...
            IDictionary<string, string> sortedParams = new SortedDictionary<string, string>(dicArrayPre);
            foreach (KeyValuePair<string, string> temp in sortedParams)
            {
