<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebSystem.Systestcomjun.PostType.List" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">职位类型</div>
                    <div class="panel-body" style="padding-bottom: 0px">
                        <div class="pull-left">
                            ...
                            <%--<a class="btn btn-primary" href="../PostInfo/List.aspx" >职位大数据</a>--%>
                        </div>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:;" name="child">子类</a>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
