<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Completiondegree.aspx.cs" Inherits="WebSystem.Systestcomjun.statistic.Completiondegree" %>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-6">
                            <table>
                                <tr style="line-height:50px;"><td style="width:300px;">0%—20%：</td><td><%=ershi %>人</td></tr>
                                <tr style="line-height:50px;"><td style="width:300px;">0%—50%：</td><td><%=wushi %>人</td></tr>
                                <tr style="line-height:50px;"><td style="width:300px;">0%—80%：</td><td><%=bashi %>人</td></tr>
                                <tr style="line-height:50px;"><td style="width:300px;">0%—100%：</td><td><%=yibai %>人</td></tr>
                            </table>
                        </div>
