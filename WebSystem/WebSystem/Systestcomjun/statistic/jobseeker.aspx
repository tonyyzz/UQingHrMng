<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jobseeker.aspx.cs" Inherits="WebSystem.Systestcomjun.statistic.jobseeker" %>
                    ...
                    <div class="panel-body">
                        <div class="col-md-6">
                            <table>
                                ...
                                <tr style="line-height:50px;"><td style="width:300px;">录入了简历的：</td><td><%=jianli %>人</td></tr>
                                <tr style="line-height:50px;"><td style="width:300px;">发单量：</td><td><%=orderscount %>次</td></tr>
                            </table>
                        </div>
