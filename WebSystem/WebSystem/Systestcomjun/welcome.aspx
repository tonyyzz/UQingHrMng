				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><asp:Literal ID="ltlorder" runat="server"></asp:Literal></div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3" style="display:none;">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><asp:Literal ID="ltlperson" runat="server"></asp:Literal></div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><asp:Literal ID="ltlseruser" runat="server"></asp:Literal></div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><asp:Literal ID="ltltixian" runat="server"></asp:Literal></div>
