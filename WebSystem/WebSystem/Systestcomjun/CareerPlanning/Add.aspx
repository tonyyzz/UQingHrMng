<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="WebSystem.Systestcomjun.CareerPlanning.Add" %>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label>标题</label>
                                <asp:TextBox ID="txtCPTitle" runat="server" class="form-control" t="txt" n="1" MaxLength="30" placeholder="输入标题，必填"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>标题图片</label>
                            ...
                            <div class="form-group">
                                <label>作者</label>
                                <asp:TextBox ID="txtCPName" runat="server" class="form-control" t="txt" n="1" MaxLength="10" placeholder="输入作者，必填"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>联系方式</label>
                            ...
                            <div class="form-group">
                                <label>详细描述</label>
                                <asp:TextBox ID="txtCPDes" runat="server" class="form-control" t="txt" n="1"  style="width:100%;height:500px;"  placeholder="输入描述信息，必填" TextMode="MultiLine" Height="100px"></asp:TextBox>
                            </div>
                        </div>
