<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebSystem.Systestcomjun.CareerPlanning.List" %>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>[<%#Eval("CPType") %>]<%#Eval("CPTitle") %></td>
                                            <td><%#Eval("CPName") %></td>
                                            <td><%#Eval("Phone") %></td>
                                            <td>
