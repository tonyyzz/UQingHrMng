...
<body>
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><asp:LinkButton ID="btnLogout" runat="server" OnClick="btnLogout_Click"><span class="glyphicon glyphicon-log-out"></span> 安全退出</asp:LinkButton></li>
						</ul>
					</li>
				</ul>
			</div>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar" style="position:absolute;bottom:0; left:0;">
		...
		<ul class="nav menu">
			<li r="1" style="display:none;"><a href="SysSet.aspx" target="frm"><span class="glyphicon glyphicon-cog"></span>系统管理</a></li>
