...
namespace ZhongLi.Common
{
    public class Utils
    {
        ...
        /// 获取两日期之间相差的天数
        /// </summary>
        /// <param name="timeone">minTime</param>
        /// <param name="timetwo">maxTime</param>
        /// <returns>相隔天数</returns>
        public static int GetTimesDays(DateTime timeone, DateTime timetwo)
        {
            if (timeone != null && timetwo != null)
            {
                DateTime timeOne = Convert.ToDateTime(timeone);
                DateTime timeTwo = Convert.ToDateTime(timetwo);
                return Math.Abs(((TimeSpan)(timetwo - timeone)).Days);
            }
            return 0;
        }
        ...
        #region 判断是否被选中
        public static string GetSelected(object i, string value)
        {
        ...
        public static string GetChecked(object i, string value)
        {
            string result = string.Empty;
            if (i.ToString() == value)
            {
        ...
        public static string ReplaceString(string inputString)
        {
            ...
            if (((((str.IndexOf("exec") >= 0) || (str.IndexOf("insert") >= 0)) || ((str.IndexOf("delete") >= 0) || (str.IndexOf("update") >= 0))) || (((str.IndexOf("char") >= 0) || (str.IndexOf("drop") >= 0)) || ((str.IndexOf("cast") >= 0) || (str.IndexOf("declare") >= 0)))) || (str.IndexOf("script") >= 0))
            {
            ...
            inputString = inputString.Replace("cast", "");
        ...
        /// <param name="strName">名称</param>
        /// <param name="strValue">值</param>
        public static void WriteSession(string strName, string strValue, int Expires)
        {
            //HttpCookie cookie = HttpContext.Current.Request.Cookies[strName];
            ...
            HttpContext.Current.Response.Expires = Expires;
        ...
        /// <param name="values">对比值</param>
        /// <returns></returns>
        public static string GetSelected(object value, object values)
        {
            string sResult = string.Empty;
            if (value != null && values != null)
            {
                if (value.ToString().Trim() == values.ToString().Trim())
                {
                    sResult = "selected=\"selected\"";
                }
            }
            return sResult;
        }
        ...
        /// <param name="values">对比值</param>
        /// <returns></returns>
        public static string GetChecked(object value, object values)
        {
            string sResult = string.Empty;
            if (value != null && values != null)
            {
        ...
        #region 判断权限
        public static bool CheckRole(string num)
        {
            string r = GetCookie("role");
            if (r != "")
            {
                string[] rs = r.Split(',');
                if (rs.Contains(num))
