...
namespace ZhongLi.DAL
{
	...
	public partial class ServerUser_Evaluate
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "ServerUser_Evaluate"); 
		}
        ...
        public bool Exists(int ID)
        {
            ...
            int result = DbHelperSQL.RunProcedure("ServerUser_Evaluate_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        ///  增加一条数据
        /// </summary>
        public int Add(ZhongLi.Model.ServerUser_Evaluate model)
        {
            int rowsAffected;
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4),
            ...
            DbHelperSQL.RunProcedure("ServerUser_Evaluate_ADD", parameters, out rowsAffected);
        ...
        ///  更新一条数据
        /// </summary>
        public bool Update(ZhongLi.Model.ServerUser_Evaluate model)
        {
            int rowsAffected = 0;
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4),
            ...
            DbHelperSQL.RunProcedure("ServerUser_Evaluate_Update", parameters, out rowsAffected);
            if (rowsAffected > 0)
            {
                return true;
            }
        ...
        public bool Delete(int ID)
        {
            ...
            DbHelperSQL.RunProcedure("ServerUser_Evaluate_Delete", parameters, out rowsAffected);
            if (rowsAffected > 0)
            {
                return true;
            }
        ...
        public bool DeleteList(string IDlist)
        {
            ...
            strSql.Append("delete from ServerUser_Evaluate ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public ZhongLi.Model.ServerUser_Evaluate GetModel(int ID)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
            ...
            ZhongLi.Model.ServerUser_Evaluate model = new ZhongLi.Model.ServerUser_Evaluate();
            DataSet ds = DbHelperSQL.RunProcedure("ServerUser_Evaluate_GetModel", parameters, "ds");
        ...
        /// 得到一个对象实体
        /// </summary>
        public ZhongLi.Model.ServerUser_Evaluate DataRowToModel(DataRow row)
        {
            ZhongLi.Model.ServerUser_Evaluate model = new ZhongLi.Model.ServerUser_Evaluate();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,SerUserID,RealName,EvaluateCon,EvaluateTime,EvaluateUserID,EvaluateName,EvaLevel,OrderID,EvaluateType ");
            strSql.Append(" FROM ServerUser_Evaluate ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,SerUserID,RealName,EvaluateCon,EvaluateTime,EvaluateUserID,EvaluateName,EvaLevel,OrderID,EvaluateType ");
            strSql.Append(" FROM ServerUser_Evaluate ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM ServerUser_Evaluate ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
            ...
            strSql.Append(")AS Row, T.*  from View_ServerUser_Evaluate T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ServerUser_Evaluate";
