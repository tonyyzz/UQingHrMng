...
namespace ZhongLi.BLL
{
	...
	{
		private readonly ZhongLi.DAL.WelfareTag dal=new ZhongLi.DAL.WelfareTag();
		public WelfareTag()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<ZhongLi.Model.WelfareTag> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZhongLi.Model.WelfareTag> DataTableToList(DataTable dt)
		{
			List<ZhongLi.Model.WelfareTag> modelList = new List<ZhongLi.Model.WelfareTag>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZhongLi.Model.WelfareTag model;
